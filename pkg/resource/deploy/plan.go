...
type Plan struct {
	...
	news                 *resourceMap                     // the set of new resources generated by the plan
...
func NewPlan(ctx *plugin.Context, target *Target, prev *Snapshot, plans map[resource.URN]*ResourcePlan, source Source,
	...
	// Create a resource map for the plan.
...
// or update.
func (p *Plan) Execute(ctx context.Context, opts Options, preview bool) (map[resource.URN]*ResourcePlan, result.Result) {
