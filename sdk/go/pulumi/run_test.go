...
// TODO[pulumi/pulumi#5801]: The signature and implementation of this will need to be updated as described in the issue.
func (module) Construct(name, typ string, args map[string]interface{}, urn string) (Resource, error) {
	switch typ {
...
func TestRegisterResourceWithResourceReferences(t *testing.T) {
	...
	// TODO[pulumi/pulumi#5801]: This call will need to be updated based on the signature change described in the issue.
